...
export const ThemeManager = (function () {
    ...
    return {
         ...
         * @param item_name
         * @param {"default"|"highlighted"|"selected"|"hover"|"border"} suffix
         * @returns {string}
         */
        getBgColor(item_name, suffix = "default") {
         ...
         * @returns {string}
         */
        getFgColor(item_name, suffix = "default") {
         ...
         * @returns {string}
         */
        getTextColor(suffix = "on-background") {
